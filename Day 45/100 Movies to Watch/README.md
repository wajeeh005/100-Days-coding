...
1. First used requests to get the get data from the url.  


2. Inspect the page to know what we have to get from the website for tag, id and class.  


3. Used **BeautyifulSoup** to fetch all the data of tag "h3" and class name is "title".  

4. Used **getText()** to fetch all the movies name also used for loop to go through the whole list of movies.  

5. Then make a file name "movies.txt" and write all the movies to that list. 